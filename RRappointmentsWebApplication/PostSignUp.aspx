...
<link href="Styles/PostSignUpStyle.css" rel="stylesheet" type="text/css" />
        ...
        <tr>
            ...
            <td class="style4"><br />
                <asp:Label ID="Label1" runat="server" Font-Size="XX-Large" ForeColor="#999999" 
                    Text="!הרשמתך למערכת זימון התורים הסתיימה בהצלחה"></asp:Label><%--"#3399FF"--%>
            </td>
        </tr>
        <tr>
            <td class="style2">
...
<div class="index_botom_line" style="background-color: #FFFFFF" align="left">
  <div class="index_RR"><a href="http://www.rrsystems.co.il/" target="_blank"><img src="images/RR.png" alt="ר.ר. מערכות" width="25" height="25" border="0" align="left" /></a></div>
Designed by 
