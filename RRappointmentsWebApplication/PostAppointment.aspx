<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostAppointment.aspx.cs" Inherits="RRappointmentsWebApplication.PostAppointment" %>
...
<head runat="server">
    ...
    <link href="Styles/PostAppointmentStyle.css" rel="stylesheet" type="text/css" />
...
<div class="index_body" style="background-color: #FFFFFF">
    <table bgcolor="White" cellpadding="10px">
        <tr>
            ...
            <td class="style4"><br />
                <asp:Label ID="Label1" runat="server" Font-Size="XX-Large" ForeColor= "#999999"
                    Text="!סיום זימון תור"></asp:Label><%--"#3399FF"--%>
            </td>
        </tr>
        <tr>
            <td class="style2">
            ...
            <td class="style5">
                <asp:Label ID="Label2" runat="server"                  
                    Text=".תודה שנרשמת במערכת זימון תורים המקוונת, מקווים לראותך שוב" 
        ...
        <tr>
            <td class="style1"></td>
            <td class="style7" style="height: 253px"></td>
        </tr>
    </table>
</div>
