    ...
    $.fn.extend({
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                //container.append(btnFirst).append(btnPrev).append(list).append(btnNext).append(btnLast).append($('<div/>').addClass('short').append(inputPage).append(btnGo));  // commented on 17/07/2013
                container.append(btnLast).append(btnNext).append(list).append(btnPrev).append(btnFirst).append($('<div/>').addClass('short').append(inputPage).append(btnGo));  // corrected on 17/07/2013
                ...
                function showLabels(pageIndex) {
                    ...
                    // commented on 04/07/2013 : /////////////////////////////////////////////////////////////////
//                    container.append($('<span/>').append($('<b/>').text(pageIndex * settings.recordsperpage + 1)))
//                                             .append($('<span/>').text('-'))
//                                             .append($('<span/>').append($('<b/>').text(upper)))
//                                             .append($('<span/>').text('of'))
//                                             .append($('<span/>').append($('<b/>').text(settings.totalrecords)));
                    // corrected by Alex.H on 04/07/2013 : ///////////////////////////////////////////////////////
                    container.append($('<span/>').append($('<b/>').text(settings.totalrecords)))
                                             .append($('<span/>').text('מתוך'))
                                             .append($('<span/>').append($('<b/>').text(upper)))
                                             .append($('<span/>').text('-'))
